.. rat documentation master file, created by
   sphinx-quickstart on Tue May 15 23:30:47 2012.
...
Overview
--------
RAT is a simulation and analysis package built with `GEANT4 <http://geant4.cern.ch>`_, `ROOT <http://root.cern.ch>`_, and C++, originally developed by S. Seibert for the Braidwood Collaboration. It is now being used (and developed) by the miniCLEAN, DEAP-3600, and SNO+ collaborations.
